...
describe('ECS Vector3 tests', () => {
  it('vector3.rotate', () => {
    expect(
      vector3ToString(new Vector3(1, 1, 1).rotate(Quaternion.Euler(45, 60, 90)))
    ).toEqual(results.rotatedWithQuat01)

    expect(
      vector3ToString(
        new Vector3(1, 0, -0.5).rotate(Quaternion.Euler(-165, 55, 125))
      )
    ).toEqual(results.rotatedWithQuat02)

    expect(
      vector3ToString(
        new Vector3(100, -90, 35).rotate(Quaternion.Euler(45, 60, 90))
      )
    ).toEqual(results.rotatedWithQuat03)

    expect(
      vector3ToString(
        new Vector3(100, 200, 300).rotate(
